          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <AnimatedSection delay={0.1}>
                ...
                >
                  Branding das<br />
                  <span className="bg-gradient-to-r from-[#2563EB] to-[#93C5FD] bg-clip-text text-transparent">in Erinnerung bleibt</span>
                </h2>
              </AnimatedSection>
              <AnimatedSection delay={0.15}>
      ...
      <section className="py-28 relative overflow-hidden" aria-labelledby="inbegriffen-heading">
        <div className="page-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              <AnimatedSection>
                <span className="inline-block text-[#2563EB] text-xs font-bold uppercase tracking-[0.22em] mb-4">Im Lieferumfang</span>
                <h2
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {inbegriffen.map((item, i) => (
                  <div
                    ...
                    style={{
                      background: "linear-gradient(135deg, rgba(37,99,235,0.07) 0%, rgba(255,255,255,0.02) 100%)",
                      border: "1px solid rgba(37,99,235,0.12)",
                    }}
                  >
                    <span className="shrink-0 w-6 h-6 rounded-full bg-[#2563EB]/15 border border-[#2563EB]/30 flex items-center justify-center">
                      <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                        <path d="M2 5l2.2 2.2 3.8-4.2" stroke="#60A5FA" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                    </span>
          ...
          <AnimatedSection>
            <div className="text-center mb-24">
              ...
              <h2 id="prozess-heading" className="text-4xl md:text-5xl font-bold text-white leading-tight mb-5" style={{ fontFamily: "var(--font-plus-jakarta)" }}>
                So entsteht{" "}
                <span className="bg-gradient-to-r from-[#2563EB] via-[#60A5FA] to-[#93C5FD] bg-clip-text text-transparent">Ihre Marke</span>
              </h2>
        ...
        <div className="page-container relative text-center">
          <AnimatedSection>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/anfragen/branding"
                className="inline-flex items-center gap-2 bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-semibold px-10 py-4 rounded-full transition-all duration-200 hover:shadow-[0_0_40px_rgba(37,99,235,0.55)] text-base"
              >
