...
export default function FreeDemo() {
  return (
    <section id="demo" className="py-20 md:py-32 bg-[#020408]">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10">
              ...
              <div className="max-w-xl">
                ...
                <p className="mt-4 text-white/40 text-base leading-relaxed">
                  Andere zeigen Mockups. Wir zeigen Ihnen Ihre fertige Website — in 48–72 Stunden.
                </p>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  {[
                    ...
                    <span
                      key={text}
                      className="inline-flex items-center gap-1.5 text-white/50 text-xs px-3 py-1.5 rounded-full border border-white/[0.07] bg-white/[0.03]"
                    >
              ...
              <div className="flex flex-col items-start lg:items-end gap-3 shrink-0">
                ...
                <span className="text-white/30 text-xs">Kostenlos & unverbindlich</span>
              </div>
